...
**一个面向个人和家庭的健康管理助手：平时能记、能查、能提醒；不舒服时能分诊；准备看医生时还能先帮你整理一版就医摘要，并按需导出成图片或 PDF。**
...
- **medical-search**：药物安全、禁忌、交互、疾病知识的权威搜索入口
- **symptom-triage**：用户描述不舒服时，先追问，再搜索验证，给方向性建议
- **first-aid**：急救场景下直接给标准步骤
- **health-education**：分层推荐靠谱科普内容
- **diagnosis-comparison**：对比多个来源的意见，展示一致点和分歧点

这些能力并不替代医生，但能在“日常咨询 → 需要就医”之间提供一个更安全、更结构化的过渡层。

对应入口：
- `medical-search/SKILL.md`
- `symptom-triage/SKILL.md`
- `first-aid/SKILL.md`
- `health-education/SKILL.md`
- `diagnosis-comparison/SKILL.md`
...
**记录 → 积累 → 查询 → 监测 → 提醒 → 分诊 → 就医准备 → 图片/PDF 导出**
