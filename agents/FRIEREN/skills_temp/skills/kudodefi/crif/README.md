...
### The CRIF Approach: Interactive Collaboration

Instead of autonomous execution, CRIF transforms research into a **collaborative team session** between you and AI:
...
**CRIF is a prompt engineering framework written entirely in natural language (YAML + Markdown) with zero lines of code.** This means you can easily read, understand, and customize any part of the framework to fit your needs.

### Flexibility: Collaborative or Autonomous

While CRIF is designed for **interactive collaboration** (recommended), it also supports **autonomous mode** when appropriate:
...
CRIF enables **iterative human-AI collaboration** through continuous interaction:
...
Paste the following prompt to your AI agent:
```
I want to use this framework: https://github.com/kudodefi/crif
```
...
[Open an issue](https://github.com/kudodefi/crif/issues) or submit a pull request.
