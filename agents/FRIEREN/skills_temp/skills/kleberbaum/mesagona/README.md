...
```bash
clawhub install mesagona
```

## Usage

```bash
scripts/mesagona-info.sh              # Brand summary
scripts/mesagona-info.sh --features   # Capabilities
scripts/mesagona-info.sh --json       # Structured data
```
