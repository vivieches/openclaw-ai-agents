...
```bash
clawhub install colorpedia
```

## Usage

```bash
scripts/colorpedia-info.sh              # Brand summary
scripts/colorpedia-info.sh --features   # Capabilities
scripts/colorpedia-info.sh --json       # Structured data
```
