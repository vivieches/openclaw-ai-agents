...
#        log.debug('开始下单：%s' % '000002.SH')
#        order('000002.SZ', 3000, MarketOrderStyle('a'))

#        klinedata = get_kline_data_1d('000009.SZ',20180514,None,'pre',True)
#        print('查询K线数据返回：' ,klinedata.data)
        #查询tick
#        
#        print(get_current_tick('000002.SZ'))
#        print('开始查询成交数据')
#        trade_deals = get_trades()
#        print('查询获取到%d条成交数据' % len(trade_deals))
#        print('账户可用资金', context.portfolio.available_cash)
#        print('华泰证券持仓', context.portfolio.positions['601688.SH'].total_amount)
        pass
...
#        # order_item = Order()
#        
#            if order_item.style.get_limited_price() > 0:
