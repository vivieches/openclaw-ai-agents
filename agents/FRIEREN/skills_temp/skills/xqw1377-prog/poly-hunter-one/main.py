...
SKILLPAY_API_KEY = os.getenv("SKILLPAY_API_KEY", "sk_8b36c2ca9e774eb0243752f907b086e78c8af866a4088d3e3475113ed446b71")
...
def invoke_info():
    return {
        "service": APP_NAME,
        "status": "ready",
        "api_connected": bool(SKILLPAY_API_KEY),
        "usage": "POST /invoke with optional {charge_id}"
    }

@app.get("/")
def root():
    return {"service": APP_NAME, "endpoints": ["/invoke (GET, POST)", "/health"]}
