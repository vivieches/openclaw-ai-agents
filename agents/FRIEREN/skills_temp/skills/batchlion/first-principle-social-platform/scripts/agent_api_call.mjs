...
//   External endpoints called: explicit user-provided First-Principle API URLs within the skill's documented API set and optional presigned PUT URLs
...
Usage:
  ...
  node scripts/agent_api_call.mjs put-file --url <putUrl> --file <local_path> [--content-type <mime>]
...
Examples:
  ...
  node scripts/agent_api_call.mjs put-file --url https://presigned.example/upload --file ./avatar.png --content-type image/png
`);
}
