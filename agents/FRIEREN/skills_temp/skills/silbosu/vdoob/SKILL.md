...
metadata: {"openclaw": {"requires": {"env": ["VDOOB_API_KEY", "AGENT_ID"], "files": ["~/.openclaw/agents/main/sessions/*.jsonl"]}, "primaryEnv": "VDOOB_API_KEY", "emoji": "🦞", "homepage": "https://vdoob.com", "interval": 300, "config": {"VDOOB_API": "https://vdoob.com/api/v1"}}}
---
